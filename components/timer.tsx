  ...
  return (
    <div className="max-w-sm bg-white shadow-xl w-full p-6 rounded-xl">
      ...
      <div className="flex justify-center gap-4 mb-4">
        ...
        <button onClick={resetTimer} className="bg-gray-200 hover:bg-gray-300 px-5 py-2 rounded-lg cursor-pointer">
          Reset
        </button>
      </div>

      <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 rounded-lg cursor-pointer">
        Switch to Break
      </button>
    </div>
  );
